...
class BattleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        player = Player(
            //name: "勇者", imageName: "yusya.png", attackPoint: 20, maxHP: 100
            name: "勇者", imageName: "yusya.png", attackPoint: 20, fireAttackPoint: 30, maxHP: 100, maxTP: 30
        )
    ...
    func updateUI(){
        ...
        playerTPLabel.text = "TP " + String(player.currentTP) + "/" + String(player.maxTP)
    }
